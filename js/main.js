...
// script of responsive menu sticky
...
window.addEventListener('scroll', function () {
 ...
 // script responsive menu accordion effect
...
// script responsive product slider
let activeImg = 0
function slider(n) {
