<?php
	...
	{
		$message=connections::login($_POST['email'], $_POST['password'],2);
	}
?>
<html lang="en">
	<head>
			...
			<nav class="navbar-top">
				<ul class="navbar-top-ul">
					<li class="navbar-top-item">
						 <div class="navbar-top-links">Log In</div>
					</li>
				</ul>
			</nav>
		<!--Nav bar-->	
			...
			<div class="columns">
				<div class="column">
					 <form action="login.php" method="post" class="form-control">
						<h2 class="footer-socials is-size-4">Login</h2>
						...
						<button name= "login" type = "submit" class="btn btn-default btn-primary">Log In</button>
					</form>
				</div>
			</div>
		</div>
